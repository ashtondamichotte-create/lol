...
<html>
	...
	<head data-machine-id="<%= pageMeta.MachineID %>">
		...
		<meta
			name="locale-data"
			data-language-code="<%= sessionUser.LanguageCode %>"
			data-language-name="<%= sessionUser.LanguageName %>"
		/>
		<meta
			name="device-meta"
			data-device-type="<%= sessionUser.Device.DeviceName %>"
			data-is-in-app="<%= sessionUser.Device.IsInApp %>"
			data-is-desktop="<%= sessionUser.Device.IsDesktop %>"
			data-is-phone="<%= sessionUser.Device.IsPhone %>"
			data-is-tablet="<%= sessionUser.Device.IsTablet %>"
			data-is-console="<%= sessionUser.Device.IsConsole %>"
			data-is-android-app="<%= sessionUser.Device.IsAndroidApp %>"
			data-is-ios-app="<%= sessionUser.Device.IsIosApp %>"
			data-is-uwp-app="<%= sessionUser.Device.IsUWPApp %>"
			data-is-xbox-app="<%= sessionUser.Device.IsXboxApp %>"
			data-is-amazon-app="<%= sessionUser.Device.IsAmazonApp %>"
			data-is-win32-app="<%= sessionUser.Device.IsWin32App %>"
			data-is-studio="<%= sessionUser.Device.IsStudio %>"
			data-is-game-client-browser="<%= sessionUser.Device.IsGameClientBrowser %>"
			data-is-ios-device="<%= sessionUser.Device.IsIosDevice %>"
			data-is-android-device="<%= sessionUser.Device.IsAndroidDevice %>"
			data-is-universal-app="<%= sessionUser.Device.IsUniversalApp %>"
			data-app-type="unknown"
		/>
		<meta name="environment-meta" data-is-testing-site="true" />

		<meta id="roblox-display-names" data-enabled="<%= globalMeta.Experiments.DisplayNamesEnabled %>" />
		...
		<link rel="canonical" href="https://www.sitetest4.robloxlabs.com/newlogin" />
		...
		<link
			onerror="Roblox.BundleDetector && Roblox.BundleDetector.reportBundleError(this)"
			rel="stylesheet"
			href="https://static.rbxcdn.com/css/page___b0dafd506d198313adc7eb9bccc23fbb_m.css/fetch"
		/>
		...
		<link
			rel="stylesheet"
			onerror="Roblox.BundleDetector && Roblox.BundleDetector.reportBundleError(this)"
			data-bundlename="CrossDeviceLoginDisplayCode"
			data-bundle-source="Main"
			href="https://css.rbxcdn.com/5f0aaea202731154b5586a247c44150da5f63e70d4c0e03cdabe06c62e76d10c.css"
		/>
		<link
			rel="stylesheet"
			onerror="Roblox.BundleDetector && Roblox.BundleDetector.reportBundleError(this)"
			data-bundlename="AccountRecoveryModal"
			data-bundle-source="Main"
			href="https://css.rbxcdn.com/4b5dce375cef78073d2192583d1ecd458f10c308fa99847d649d5ec801bebd61.css"
		/>
		...
		<link
			rel="stylesheet"
			onerror="Roblox.BundleDetector && Roblox.BundleDetector.reportBundleError(this)"
			data-bundlename="Login"
			data-bundle-source="Main"
			href="https://css.rbxcdn.com/5eb9680d41912dde3d60eaf0d84afe08b3d3e7336862bf0a854b6c2f93cb2d42.css"
		/>
	...
	>
		<meta name="csrf-token" data-token="kxXJ01HlUyUG" />
		...
		<div id="wrap" class="wrap no-gutter-ads logged-out" data-gutter-ads-enabled="false">
			<div id="navigation-container" class="dark-theme gotham-font" data-number-of-autocomplete-suggestions="0">
			...
			<div class="container-main" id="container-main">
				...
				<div class="alert-container">
					...
					<div class="alert-cookie-notice" data-cookie-notice-timeout="20000">
						...
						<a href="https://www.sitetest4.robloxlabs.com/info/privacy?locale=en_us">Privacy and Cookie Policy</a>.)
				...
				<div class="content">
					...
					<script>
						var Roblox = Roblox || {};
						Roblox.LoginMeta = {
							signupUrl: 'https://www.sitetest4.robloxlabs.com/account/signupredir',
							forgotCredentialsUrl: 'https://www.sitetest4.robloxlabs.com/login/forgot-password-or-username',
							homeUrl: 'https://www.sitetest4.robloxlabs.com/home',
							securityNotificationUrl: 'https://www.sitetest4.robloxlabs.com/login/securitynotification',
							apiProxyUrl: 'https://api.sitetest4.robloxlabs.com',
							fbSignInUrl: '',
							loginPageUrl: 'https://www.sitetest4.robloxlabs.com/newlogin',
			...
			Roblox.PlaceLauncher.Resources = {
				...
				ProtocolHandlerAreYouInstalled: {
					play: {
						...
						footerContent:
							"<a href='https://assetgame.sitetest4.robloxlabs.com/game/help'class= 'text-name small' target='_blank' >Click here for help</a> ",
					},
					studio: {
						content:
		...
		<script type="text/javascript">
			function checkRobloxInstall() {
				return RobloxLaunch.CheckRobloxInstall('https://www.sitetest4.robloxlabs.com/Download');
			}
		</script>
		...
		<script type="text/javascript">
			...
			Roblox.Client._installHost = 'setup.sitetest4.robloxlabs.com';
		...
		<script type="text/javascript">
			$(function () {
				Roblox.CookieUpgrader.domain = 'sitetest4.robloxlabs.com';
		...
		<script
			...
			type="text/javascript"
			src="https://js.rbxcdn.com/700b2a99c40bbe02b6862bc5205e5249.js"
		></script>
		...
		<script
			...
			data-bundlename="Captcha"
			data-bundle-source="Main"
			src="https://js.rbxcdn.com/c9c50ff75a03b1dae3fe26ad47d7a38d51cb97f48e027b4eaa97f7efa66a0243.js"
		></script>
		<script
			type="text/javascript"
			onerror="Roblox.BundleDetector && Roblox.BundleDetector.reportBundleError(this)"
			...
			data-bundlename="CrossDeviceLoginDisplayCode"
			data-bundle-source="Main"
			src="https://js.rbxcdn.com/115f02aaa2d66876748e1b21aeb663b0ebf5fa91f0a5b384d4fe91fa534d1551.js"
		></script>
		<script
			type="text/javascript"
			onerror="Roblox.BundleDetector && Roblox.BundleDetector.reportBundleError(this)"
			data-monitor="true"
			data-bundlename="DynamicLocalizationResourceScript_Authentication.CrossDevice"
			data-bundle-source="Unknown"
			src="https://js.rbxcdn.com/8201e09b58f7b7775130bcdc536f216ad6ca763bb74084904f740f1af4fae7ae.js"
		></script>
		<script
			type="text/javascript"
			onerror="Roblox.BundleDetector && Roblox.BundleDetector.reportBundleError(this)"
			...
			data-bundlename="DynamicLocalizationResourceScript_Authentication.CrossDevice"
			data-bundle-source="Unknown"
			src="https://js.rbxcdn.com/9d7a24e40ce1aaa5cc6e918f313b239f94c4eea5f37201c0f8f8aa756e8c5ebc.js"
		></script>
		<script
			type="text/javascript"
			onerror="Roblox.BundleDetector && Roblox.BundleDetector.reportBundleError(this)"
			...
			data-bundlename="AccountRecoveryModal"
			data-bundle-source="Main"
			src="https://js.rbxcdn.com/776980ab06da25eebcacad844208e2544e091c8c295d69906976ccaaaeeb5d30.js"
		></script>
		<script
			type="text/javascript"
			onerror="Roblox.BundleDetector && Roblox.BundleDetector.reportBundleError(this)"
		...
		<script
			...
			onerror="Roblox.BundleDetector && Roblox.BundleDetector.reportBundleError(this)"
			data-monitor="true"
			data-bundlename="DynamicLocalizationResourceScript_Authentication.ResetPassword"
			data-bundle-source="Unknown"
			src="https://js.rbxcdn.com/168a7c305202c84e8e2293560b5335304f3416e2b384a452ad8f03f1b35d94b2.js"
		></script>
		<script
			type="text/javascript"
			onerror="Roblox.BundleDetector && Roblox.BundleDetector.reportBundleError(this)"
			...
			data-bundlename="DynamicLocalizationResourceScript_Authentication.ResetPassword"
			data-bundle-source="Unknown"
			src="https://js.rbxcdn.com/c55742649bbcdecac8a71b1394be0e2882e8d40c508b2c5a502633624b30a750.js"
		></script>
		...
		<script
			...
			data-bundlename="Login"
			data-bundle-source="Main"
			src="https://js.rbxcdn.com/bdfefe27f81b6084e3beab0960c27b30e834aa44eee1b24dc49a4d34ea925d5f.js"
		></script>
		<script
			type="text/javascript"
			onerror="Roblox.BundleDetector && Roblox.BundleDetector.reportBundleError(this)"
			data-monitor="true"
			data-bundlename="DynamicLocalizationResourceScript_Common.Captcha"
			data-bundle-source="Unknown"
			src="https://js.rbxcdn.com/e7b6ef0dd87d6afd26c3d9e432df58eb507507f67b0d0e1e8e1aa177eb935780.js"
		></script>
		<script
			type="text/javascript"
			onerror="Roblox.BundleDetector && Roblox.BundleDetector.reportBundleError(this)"
			...
			data-bundlename="DynamicLocalizationResourceScript_Common.Captcha"
			data-bundle-source="Unknown"
			src="https://js.rbxcdn.com/7bfb33d6daca3bf33b8279926060961ad21f195366362409b8964e2807204f6c.js"
		></script>
		<script
			type="text/javascript"
			onerror="Roblox.BundleDetector && Roblox.BundleDetector.reportBundleError(this)"
			data-monitor="true"
			data-bundlename="DynamicLocalizationResourceScript_Authentication.Captcha"
			data-bundle-source="Unknown"
			src="https://js.rbxcdn.com/03acbfb65ca7969f51d31e6ae449812c120535f4ad657e007c1d8d0c0be551e9.js"
		></script>
		<script
			type="text/javascript"
			onerror="Roblox.BundleDetector && Roblox.BundleDetector.reportBundleError(this)"
			...
			data-bundlename="DynamicLocalizationResourceScript_Authentication.Captcha"
			data-bundle-source="Unknown"
			src="https://js.rbxcdn.com/c90a75ce07429d762b224d1350d1c5de47da85b61c2e64bbc82b1eb8aeebf4a9.js"
		></script>
		<script
			type="text/javascript"
			onerror="Roblox.BundleDetector && Roblox.BundleDetector.reportBundleError(this)"
			data-monitor="true"
			data-bundlename="DynamicLocalizationResourceScript_Authentication.Login"
			data-bundle-source="Unknown"
			src="https://js.rbxcdn.com/db21bb39bf16c0d81f6dc79e0efef1f20bd00ab6ebb67458e546b4f9a6b16f52.js"
		></script>
		<script
			type="text/javascript"
			onerror="Roblox.BundleDetector && Roblox.BundleDetector.reportBundleError(this)"
			...
			data-bundlename="DynamicLocalizationResourceScript_Authentication.Login"
			data-bundle-source="Unknown"
			src="https://js.rbxcdn.com/f8d19e0acb7957b3aa68980590e8bf62f7a3745c6a062e4fe8dbea7a50823d66.js"
		></script>
		...
		<script
			...
			type="text/javascript"
			src="https://js.rbxcdn.com/9119df9e81e14170cd50df84059b8004.js"
		></script>
	</body>
</html>
